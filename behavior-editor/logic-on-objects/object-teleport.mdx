...
<Steps>
  ...
  <Step title="Set your Trigger">
   ...
   <Step title="Add Object Action">
    ...
    <p align="center">
      <img width="200" noZoom src="https://i.imgur.com/0Meaj9P.png"/>
      </p>
  </Accordion>
  </Step>
  <Step title="Build Your Custom Graph">
    ...
    <p align="center">
      <img width="200" noZoom src="https://i.imgur.com/3wQTZHR.png"/>
      </p>
  </Accordion>
 </Step>

  <Step title="Select Where Your Object Will Teleport">
    On "Editor Object Sources" node, click on the cube to the right and select the object you want to teleport your object to, and confirm the selection.
