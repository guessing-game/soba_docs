...
<Steps>
  ...
  <Step title="Set your Trigger">
   ...
   <Step title="Create a Delivery Event">
    ...
    <Step title="Playtest!">
     After setting up the movements, test your game to see how the object behaves and make adjustments for the perfect [effect](https://wiki.soba.xyz/behavior-editor/game-logic/particles).
  </Step>
  </Steps>
