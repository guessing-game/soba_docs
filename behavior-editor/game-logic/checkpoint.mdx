...
Game checkpoints are key to prevent the need to repeat large portions of the map, or to reduce tedium by providing a sense of accomplishment as players progress through the game! Follow the steps below to add a checkpoint to your game:
