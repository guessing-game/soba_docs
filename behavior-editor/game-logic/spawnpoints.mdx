...
For the different spawn points, you’ll need to build custom logic. Tap on the position number and select “Add Custom Graphs”:
  ...
  <Accordion title="3. Connect your nodes so that when the object list is shuffled, a position is picked, converted into coordinates, and then used as the final teleport destination (as illustrated below)">
    <p align="center">
