...
|Object Actions|`Enable Physics`          |Physics |Enable physics on an object.                                                       |
|Object Actions|`Disable Physics`          |Physics |Disable physics on an object.                                                       |
|Object Actions|`Add Force`          |Physics |Add force to an object.                                                       |
|Object Actions|`Add Impulse`          |Physics |Add one time linear impulse to an object.                                                       |
|Object Actions|`Add Torque`          |Physics |Add a torque to the object.                                                       |
