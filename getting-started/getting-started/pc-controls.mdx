...
<Note> ### Known issues
- At this point we’re not optimising a lot of the UI, we might do this at some later point
- The mouse sensitivity might be very high or low depending on your hardware settings (DPI). This will soon be configurable.
- Audio volume will soon be configurable
...
- On Windows, you can quit Soba using Alt + F4
- Behaviors can only be copied and pasted within the same game</Note>
